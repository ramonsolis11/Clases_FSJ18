/* foreach
El método forEach es una forma conveniente y legible de iterar sobre elementos de un arreglo y ejecutar una acción para cada uno. Se utiliza comúnmente cuando no necesitas realizar transformaciones en el arreglo original, sino simplemente ejecutar una operación en cada elemento. */

let notas = [7,8,6.5,4,9,8.2];
